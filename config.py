...
class Config:
    ...
    RQ_ADVISOR_QUEUE_NAME: str = os.getenv("RQ_ADVISOR_QUEUE_NAME", "internpath-advisor").strip() or "internpath-advisor"
    ...
    ADVISOR_EVENT_STREAM_MAXLEN: int = get_int_env("ADVISOR_EVENT_STREAM_MAXLEN", 10000)
    ADVISOR_EVENT_STREAM_BLOCK_MILLISECONDS: int = get_int_env("ADVISOR_EVENT_STREAM_BLOCK_MILLISECONDS", 800)
    ADVISOR_EVENT_STATUS_POLL_SECONDS: float = get_float_env("ADVISOR_EVENT_STATUS_POLL_SECONDS", 0.75)
    ADVISOR_EVENT_STREAM_CONNECT_TIMEOUT_SECONDS: float = get_float_env("ADVISOR_EVENT_STREAM_CONNECT_TIMEOUT_SECONDS", 1.0)
    ADVISOR_EVENT_STREAM_READ_TIMEOUT_SECONDS: float = get_float_env("ADVISOR_EVENT_STREAM_READ_TIMEOUT_SECONDS", 2.0)
    ADVISOR_AUTOSCALE_MIN_WORKERS: int = get_int_env("ADVISOR_AUTOSCALE_MIN_WORKERS", 1)
    ADVISOR_AUTOSCALE_MAX_WORKERS: int = get_int_env("ADVISOR_AUTOSCALE_MAX_WORKERS", 4)
    ADVISOR_AUTOSCALE_JOBS_PER_WORKER: int = get_int_env("ADVISOR_AUTOSCALE_JOBS_PER_WORKER", 2)
    ADVISOR_AUTOSCALE_POLL_SECONDS: float = get_float_env("ADVISOR_AUTOSCALE_POLL_SECONDS", 5.0)
    ADVISOR_MODEL_CLIENT_TTL_SECONDS: int = get_int_env("ADVISOR_MODEL_CLIENT_TTL_SECONDS", 900)
    ADVISOR_CONTEXT_MAX_CHARS: int = get_int_env("ADVISOR_CONTEXT_MAX_CHARS", 6000)
    ADVISOR_CONTEXT_RECENT_TURNS: int = get_int_env("ADVISOR_CONTEXT_RECENT_TURNS", 6)
