...
def test_doubao_cache_concurrency():
    from backend.doubao_job_rag import _limit_cache_size as doubao_limit_size, _CACHE_LOCK as doubao_lock
    test_dict = {}
    errors = []
    ...
    def worker(worker_id):
        try:
            for i in range(500):
                ...
                # Concurrently evict from dictionary under lock
                doubao_limit_size(test_dict, max_size=50)
        except Exception as e:
            errors.append(e)
